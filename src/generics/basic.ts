export default function genericsBasicSample() {
  ...
  //↑だと構造は似ているのに、関数ごとに型を何度も記述しなければなれない
  //↓のように書くこともできるが、これもまた型の種類が増えると追加で書かなければならない
  type Reduce = {
  ...
  console.log("Generics basic sample 3:", genericStringReduce(["MAKE ", "TYPESCRIPT " , "GRATE ", "AGAIN"], ""));
